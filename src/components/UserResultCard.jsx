...
function UserResultCard({ onView, user }) {
  ...
  return (
    <article className="rounded-2xl border border-[#2d3a5c] bg-[#161d33] p-5 transition hover:-translate-y-1 hover:border-[#f59e0b]">
      ...
      <button className="mt-5 inline-flex items-center gap-2 text-sm font-medium text-[#f59e0b] hover:text-[#fbbf24]" onClick={() => onView(user.login)} type="button">View profile <ExternalLink size={15} /></button>
    </article>
  )
}
